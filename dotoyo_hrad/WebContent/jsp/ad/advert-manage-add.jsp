...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>增加广告</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="sysAd!add.action" enctype="multipart/form-data">
	        <div class="inside-tab">
	              ...
	              <tr>
	                ...
	                <td align="left" class="tab-input">
						<s:select id="province" name="dto.province" onchange="COM_setSelectTitle(this,0)" list="provinces" listKey="code" listValue="name" headerKey="" headerValue="省" cssStyle="width:120px;" cssClass="validate[custom[requiredSelected]]"/>
						<s:select id="city" name="dto.city" list="citys" listKey="code" onchange="COM_setSelectTitle(this,1)" listValue="name" headerKey="" headerValue="市" cssStyle="width:120px;" cssClass="validate[custom[requiredSelected]]"/>
	              ...
	              <tr>
	                ...
	                <td align="left" class="tab-input">
	                	<s:textfield type="text" readonly="readonly" id="startDate" name="dto.start" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y'-'%m'-'%d',maxDate:'#F{$dp.$D(\\'endDate\\')}'})" cssStyle="" cssClass="validate[custom[nullCheckS],minCurrentDay]"/>
	                		&nbsp;至&nbsp;
	                	<s:textfield type="text" readonly="readonly" id="endDate" name="dto.end" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\\'startDate\\')}'})" cssStyle="" cssClass="validate[custom[nullCheckS],minCurrentDay]"/>
	              ...
	              <tr>
	                ...
	                <td align="left" class="tab-input">
	                	<s:radio list="types" name="dto.type" onclick="typeClick(this)" cssClass="validate[custom[nullCheckS]]"/>
...
<script type="text/javascript">
	...
	**/
	function selectTypeChange(){
		 document.getElementById("pageFrom").action="sysAd!changTypeAdd.action";
