...
<title>大太阳建筑猎头--管理员权限设置--系统功能列表</title>
...
<%@ include file="/jsp/left.jsp"%>
    <div class="content-right">
	    ...
	    <s:form id="pageFrom" name="pageFrom" method="post" action="sysFunctionRoleAdmin!functionSearch.action">
	        ...
	        <div class="qx" >
	       	...
	       	<div class="system-botton3">
	        	<ul>
	            	<li class="botton1"><a href="#" title="确定" onclick="submitForm4ChangeActionNull(pageFrom,'assignBox','sysFunctionRoleAdmin!assign.action')">确定</a></li>
	                <li class="botton3"><a href="<%=request.getContextPath()%>/sys/sysFunctionRoleAdmin!cancel.action" title="取消">取消</a></li>
	            </ul>
	        </div>
