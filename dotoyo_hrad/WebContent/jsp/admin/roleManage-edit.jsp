...
<title>大太阳建筑猎头--管理员角色管理--修改角色</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>修改管理员角色</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="sysRoleAdmin!edit.action">
