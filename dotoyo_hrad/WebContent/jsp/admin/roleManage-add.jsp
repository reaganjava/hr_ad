...
<title>大太阳建筑猎头--管理员角色管理--增加角色</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>增加管理员角色</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="sysRoleAdmin!add.action">
	        <div class="inside-tab">
	              ...
	              <tr>
	                ...
	                <td width="71%" align="left" class="tab-input">
	                	<s:textfield name="dto.code" maxLength="20" cssClass="validate[custom[nullCheckS],custom[filteringSpecialChar2]]"/>
	              ...
	              <tr>
	                ...
	                <td align="left" class="tab-input">
	                	<s:textfield name="dto.name" maxLength="20" cssClass="validate[custom[nullCheckS],custom[filteringSpecialChar]]"/>
