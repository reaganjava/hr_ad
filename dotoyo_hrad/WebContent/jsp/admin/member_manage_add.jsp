...
<title>大太阳建筑猎头--管理员管理--增加管理员</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>增加管理员</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="sysMemberAdmin!add.action">
	        <div class="inside-tab">
	              ...
	              <tr>
	                ...
	                <td width="71%" align="left" class="tab-input">
	                	<s:textfield name="userdto.userName" maxlength="40" cssClass="validate[custom[nullCheckS],custom[filteringSpecialChar3]]"/>
	                	<FONT color="red"><s:text name="userNameMsg"/></FONT>
	                </td>
	              </tr>
	              <tr>
