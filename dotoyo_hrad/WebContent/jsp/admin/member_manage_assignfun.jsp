...
<title>大太阳建筑猎头--管理员管理--分配功能点</title>
...
<%@ include file="/jsp/left.jsp"%>
    <div class="content-right">
	    ...
	    <s:form id="pageFrom" name="pageFrom" method="post" action="sysMemberAdmin!searchFun.action">
	        <div class="inside-tab">
	   	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              ...
	              <s:if test="functionDtoList!=null">
		              ...
		              <tr>
		              	<td width="5%">
		              		<s:if test='(userid==null||userid=="")&&(editable==null||editable=="")'>
		              			<input type="checkbox" name="assignBox" value="<s:text name="id"/>" />
		              		</s:if>
		              		<s:elseif test='(userid!=null&&userid!="")&&(editable==null||editable=="")'>
		              			<input type="checkbox" checked="checked" name="assignBox" value="<s:text name="id"/>"/>
		              		</s:elseif>
		              		<s:elseif test='editable!=null&&editable!=""'>
		              			<input readonly="readonly" disabled="disabled" type="checkbox" checked="checked" name="assignBox" value="<s:text name="id"/>"/>
		              		</s:elseif>
		              	</td>
	        ...
	        <div class="qx" >
	       	...
	       	<div class="system-botton3">
	        	<ul>
	            	<li class="botton1"><a href="#" onclick="submitForm4ChangeActionNull(pageFrom,'assignBox','sysMemberAdmin!assignFun.action')">确定</a></li>
