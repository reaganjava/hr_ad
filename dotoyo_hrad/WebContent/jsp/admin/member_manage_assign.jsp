...
<title>大太阳建筑猎头--管理员管理--分配角色</title>
...
<%@ include file="/jsp/left.jsp"%>
    <div class="content-right">
    	<div class="administrator-title"><strong>分配角色</strong></div>
	    <s:form id="pageFrom" name="pageFrom" method="post" action="sysMemberAdmin!search.action">
	        <div class="inside-tab">
	   	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              <tr>
	              	<td width="5%"><input id="selected" name="selected" type="checkbox" value=""/></td>
	                <td width="40%" height="40" align="left" nowrap="true"><strong>角色编码&nbsp;</strong></td>
	                <td width="55%" align="left" nowrap="true"><strong>角色名称&nbsp;</strong></td>
	              </tr>
	        ...
	        <div class="qx" >
	       	...
	       	<div class="system-botton3">
	        	<ul>
	            	<li class="botton1"><a href="#" title="确定" onclick="submitForm4ChangeActionNull(pageFrom,'assignBox','sysMemberAdmin!assign.action')">确定</a></li>
