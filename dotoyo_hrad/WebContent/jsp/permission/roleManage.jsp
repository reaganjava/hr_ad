...
<%@ include file="/jsp/left.jsp"%>
    <div class="content-right">
    	<div class="administrator-title"><strong>角色管理</strong></div>
	    <s:form id="pageFrom" name="pageFrom" method="post" action="sysRole!search.action">
	        <div class="inside-search">
	        	<ul>
	            	<li><strong>角色名称</strong>：
	            		<s:textfield id="nameHid" name="searchdto.name" size="17" maxLength="20" cssStyle="display:none"/>
	            		<input id="name" type="text" value="<s:text name="searchdto.name"/>" size="17" maxlength="20"/>
	            		</li>
	                <li><a href="#" onclick="
	   	    ...
	   	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              ...
	              <s:if test="dtoList!=null">
		              ...
		              <tr>
		                ...
		                <td width="17%" align="left"><a href="#" onclick="beforeAssign('<s:text name="id"/>')">分配角色成员</a>&nbsp;</td>
		              </tr>
	              </s:iterator>
	              </s:if>
	            </table>
	        ...
	        <div class="qx" >
	       	...
	       	<div class="system-botton3">
	        	<ul>
	            	<li class="botton1"><a href="<%=request.getContextPath()%>/sys/sysRole!beforeAdd.action">增加</a></li>
	                <li class="botton3"><a href="#" onclick="submitForm4ChangeAction(pageFrom,'removeBox','sysRole!remove.action')">删除</a></li>
	            </ul>
	        </div>
			<div class="num">
       	...
       	<div style="display:none">
       		<s:form id="sysRoleFormEdit" method="post" action="sysRole!beforeEdit.action">
				<s:hidden name="dto.id" id="edit_id"/>
       		</s:form>
       		<s:form id="sysRoleFormAssign" method="post" action="sysRole!beforeAssign.action">
