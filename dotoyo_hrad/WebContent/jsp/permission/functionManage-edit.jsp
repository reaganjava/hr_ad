...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>修改功能点名称</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="sysFunction!edit.action">
	        <div class="inside-tab">
	   	    	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="inside-tab">
	              <tr>
	                <td width="29%" height="40" align="right"><strong>功能点编码</strong>：</td>
	                <td width="71%" align="left" class="tab-input">
	                	<s:text name="dto.code"/>
	                	<s:hidden name="dto.id"/>
	                </td>
	              </tr>
	              <tr>
	                <td width="29%" height="40" align="right"><strong>功能点名称</strong>：</td>
	       	...
	       	<div class="system-botton3">
	        	<ul>
	                ...
	                <li class="botton3"><a href="<%=request.getContextPath()%>/sys/sysFunction!cancel.action" title="取消">取消</a></li>
	            </ul>
	        </div>
      	</s:form>
  		</div>
