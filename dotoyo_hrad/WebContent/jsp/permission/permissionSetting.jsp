...
<%@ include file="/jsp/left.jsp"%>
    <div class="content-right">
    	<div class="administrator-title"><strong>系统角色权限分配列表</strong></div>
	    <s:form id="pageFrom" name="pageFrom" method="post" action="sysFunctionRole!search.action">
	        ...
	        <div class="inside-tab">
	   	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              <tr>
	                ...
	                <td width="48%" align="left" nowrap="true"><strong>角色名称&nbsp;</strong></td>
	                <td width="20%" align="left" ><strong>操作&nbsp;</strong></td>
	              </tr>
	              <s:if test="dtoList!=null">
		              ...
		              <tr>
		                ...
		                <td width="48%" align="left" nowrap="true"><s:text name="name"/>&nbsp;</td>
		                <td width="20%" align="left" class="inside-links">
       	...
       	<div style="display:none">
       		<s:form id="sysFunctionRoleFormAssign" method="post" action="sysFunctionRole!beforeAssign.action">
