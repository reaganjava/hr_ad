...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>修改角色</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="sysRole!edit.action">
