...
<head>
	...
	<title>大太阳建筑猎头--系统管理--个人匹配公司职位的人才匹配</title>
	...
	<div class="content">
		...
		<div class="content-right">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td align="left" class="tab-input">
							...
							<s:elseif test='recommendationVo.isAdvisor=="N"'>
								否
							</s:elseif>
						</td>
						<td>&nbsp;</td>
			...
			<s:form id="hiddenForm" name="hiddenForm" target="_blank" method="post" action="talentMatchAction!printPosition4Personal.action">
				<s:hidden name="recommendationDto.id"></s:hidden>
			</s:form>
			<s:form  id="pageFrom" name="pageFrom" method="POST" action="talentMatchAction!matchPosition4Personal.action">
				<s:hidden name="recommendationDto.id"></s:hidden>
				<div class="qx">
