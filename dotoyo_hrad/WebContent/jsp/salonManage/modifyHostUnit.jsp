...
<s:include value="/jsp/left.jsp"/>
	<s:form id="pageFrom" name="pageFrom" method="post" action="salonAdminAction!modifyHostUnit.action" enctype ="multipart/form-data">
	<s:hidden  id="hostUnitDto.id" name="hostUnitDto.id"/>
   <div class="content-right">
    	<div class="administrator-title"><strong>修改主办单位</strong></div>
        <div class="inside-tab">
   	    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="inside-tab">
        	...
        	<ul>
	            	<li class="botton1"><a href="#" onclick="$('#pageFrom').submit()" title="提交">提交</a></li>
