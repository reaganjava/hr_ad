...
<div class="content-right">
    	...
    	<div class="inside-search2">
        	<ul>
            	<li>视频上传审核设置：<s:select name="sysParameterDto.sysValue" list="#{'1':'需要审核','0':'不需要审核'}" listKey="key" listValue="value"/></li>
            ...
            <s:hidden name="salonMediaDto.mediaType" id="salonMediaDto.mediaType"/>
   	    	 ...
   	    	 <s:iterator value="salonList">
                 <li title="<s:property value="subject"/>">
                  <a href="salonAdminAction!toMediaListBySalonPage.action?salonMediaDto.salonId=<s:property value="id"/>&salonMediaDto.mediaType=<%=ApplicationConstant.MEDIA_TYPE_VIDEO%>&salonMediaDto.status=<s:property value="salonSearchVo.status"/>">
                  ...
                  <a href="salonAdminAction!toMediaListBySalonPage.action?salonMediaDto.salonId=<s:property value="id"/>&salonMediaDto.mediaType=<%=ApplicationConstant.MEDIA_TYPE_VIDEO%>&salonMediaDto.status=<s:property value="salonSearchVo.status"/>">
                    ...
                    <p>(视频个数:<s:property value="mediaCount"/>)</p>
                  </a>
