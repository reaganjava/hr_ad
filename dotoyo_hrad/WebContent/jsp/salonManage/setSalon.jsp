...
<s:include value="/jsp/left.jsp"/>
 <div class="content-right">
      	...
      	<s:hidden id="goFrom" name="goFrom" value="2"/>
    	<div class="administrator-title"><strong>经典沙龙设置</strong></div>
        ...
        <s:form id="setSalonForm" name="setSalonForm" method="POST" action="salonAdminAction!setSalon.action">
   	    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
             ...
             <s:iterator value="salonList">
              <tr>
                ...
                <td width="13%" align="left" title="<s:property value="subject"/>"><span style="width:100px;float:left" class="index_hid_css">
                ...
                <td width="15%" align="left" title="<s:property value="location"/>"><span style="width:150px;float:left" class="index_hid_css"><s:property value="location"/></span></td>
              </tr>
            </s:iterator>
            </table>
          </s:form>
...
<s:form  id="pageFrom" name="pageFrom" method="POST" action="salonAdminAction!searchSalon.action">
     ...
     <s:hidden name="goFrom" value="2"/>
     <div class="qx">
         <s:property value="pageInfo.htmlListTableFootInfo" escapeHtml="false"/>
     </div>
     <div class="system-botton3">
        	<ul>
                <li class="botton1"><a href="#" onclick="submitFormChooseCheck(setSalonForm,'arrayIds')" title="设置为经典沙龙">设置为经典沙龙</a></li>
                <li class="botton3"><a href="#" onclick="submitForm4ChangeAction(setSalonForm,'arrayIds','salonAdminAction!cancelClassicSalon.action')" title="取消经典沙龙">取消经典沙龙</a></li>
...
<script type="text/javascript">
	function init(){
		...
		$("#salon_manager_2 a").addClass("active");
	}
</script>
</body>
</html>