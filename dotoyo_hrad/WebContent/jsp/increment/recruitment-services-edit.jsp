...
<title>大太阳建筑猎头--增值服务设置--修改招聘服务设置</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	...
    	<s:form id="pageFrom" name="pageFrom" method="post" action="recruitSetting!edit.action">
        <div class="inside-tab">
	 	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              <tr>
	                <td width="20%" align="right" valign="middle"><strong>套餐名称：</strong></td>
	                <td width="80%" height="30" align="left" class="tab-input">
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left" class="tab-input" height="30">
	                	<s:textfield name="dto.timesOfPublicPosition" cssClass="validate[required,custom[onlyNumber]]" maxLength="9"
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left" class="tab-input"  height="30">
	                	<s:textfield name="dto.timesOfLookupBlog" cssClass="validate[required,custom[onlyNumber]]" maxLength="9"
	                	onkeypress="return limitNumberOnkeyPress(this,event)"
	                	onpaste = "return limitNumberOnpaste(this)"
	                	ondrop = "return limitNumberOndrop(this,event)"></s:textfield>
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left" class="tab-input"  height="30">
	                	<s:textfield name="dto.timesOfLookupInvite" cssClass="validate[required,custom[onlyNumber]]" maxLength="9"
	                	onkeypress="return limitNumberOnkeyPress(this,event)"
	                	onpaste = "return limitNumberOnpaste(this)"
	                	ondrop = "return limitNumberOndrop(this,event)"></s:textfield>
