...
<title>大太阳建筑猎头--增值服务设置--修改猎证服务设置</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	...
    	<s:form id="pageFrom" name="pageFrom" method="post" action="huntCardSetting!edit.action">
        <div class="inside-tab">
	 	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left" height="30" class="tab-input">
