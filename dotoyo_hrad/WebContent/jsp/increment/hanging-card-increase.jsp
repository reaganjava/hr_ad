...
<title>大太阳建筑猎头--增值服务设置--增加挂证服务设置</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>增加挂证服务设置</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="hangCardSetting!add.action">
