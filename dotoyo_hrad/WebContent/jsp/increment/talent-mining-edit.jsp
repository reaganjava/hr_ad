...
<title>大太阳建筑猎头--增值服务设置--修改人才挖掘字段设置</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>修改人才挖掘字段设置</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="talentsFoundSetting!edit.action">
	 	    ...
	 	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	       	...
	       	<div class="system-botton">
	        	<ul>
	                ...
	                <li class="botton3"><a href="<%=request.getContextPath()%>/sys/talentsFoundSetting!cancel.action" title="取消">取消</a></li>
	            </ul>
	        </div>
      	</s:form>
  		</div>
