...
<title>大太阳建筑猎头--增值服务设置--增加套餐名称设置</title>
...
<jsp:include page="/jsp/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>增加套餐名称设置</strong></div>
    	<s:form id="pageFrom" name="pageFrom" method="post" action="serviceNameMainAction!add.action">
        <div class="inside-tab">
              ...
              <tr>
                ...
                <td width="88%" height="40" align="left">
                	<s:textfield name="dto.serviceCode" maxLength="20" cssClass="validate[custom[nullCheckS],custom[filteringSpecialChar2]]"></s:textfield>
              ...
              <tr>
                ...
                <td width="88%" height="40" align="left">
                	<s:select name="dto.serviceType" list="#{'0':'个人套餐','1':'企业套餐' }" cssStyle="width:152px;"></s:select>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td width="88%" height="40" align="left">
	                	<input style="ime-mode:disabled" maxlength="9" id="priceid" class="validate[custom[onlyDouble]]" value=""/>
