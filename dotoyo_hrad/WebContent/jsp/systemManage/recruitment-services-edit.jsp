...
<jsp:include page="/jsp/systemManage/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>修改招聘服务设置</strong></div>
    	<s:form name="sysIncrementRecruitFM" method="post" action="recruitSetting!edit.action">
	 	    ...
	 	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left">
	                	<s:textfield name="dto.timesOfPublicPosition" cssStyle="ime-mode:disabled" maxLength="10"
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left">
	                	<s:textfield name="dto.timesOfLookupBlog" cssStyle="ime-mode:disabled" maxLength="10"
	                	onkeypress="return limitNumberOnkeyPress(this,event)"
	                	onpaste = "return limitNumberOnpaste(this)"
	                	ondrop = "return limitNumberOndrop(this,event)"></s:textfield>
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left">
	                	<s:textfield name="dto.timesOfLookupInvite" cssStyle="ime-mode:disabled" maxLength="10"
	                	onkeypress="return limitNumberOnkeyPress(this,event)"
	                	onpaste = "return limitNumberOnpaste(this)"
	                	ondrop = "return limitNumberOndrop(this,event)"></s:textfield>
	       	...
	       	<div class="system-botton">
	        	<ul>
	            	<li class="botton1"><a href="#" onclick="document.getElementById('priceValue').value=document.getElementById('dto.price').value;document.getElementsByName('sysIncrementRecruitFM')[0].submit()" title="保存">保存</a></li>
	                <li class="botton3"><a href="<%=request.getContextPath()%>/sysIncrement/recruitSetting!cancel.action" title="取消">取消</a></li>
	            </ul>
	        </div>
      	</s:form>
  		</div>
