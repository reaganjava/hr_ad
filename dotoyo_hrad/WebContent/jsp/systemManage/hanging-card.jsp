    ...
    <div class="content-right">
        ...
        <div class="inside-tab">
   	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="21%" align="left" class="tab-padding"><strong>服务名称</strong></td>
                <td width="20%" align="left"><strong>价格</strong></td>
                <td width="25%" height="40" align="left"><strong>证书提交个数</strong></td>
              ...
              <s:if test="dtoList!=null">
	              ...
	              <tr>
	                <td width="21%" align="left" class="tab-padding"><s:text name="serviceName"/>&nbsp;</td>
	                ...
	                <td width="25%" align="left"><s:text name="countOfSubmit"/>&nbsp;</td>
	                <td width="16%" align="left"><s:text name="operatorName"/>&nbsp;</td>
	                <td width="18%" align="left" class="inside-links">
	                	<a href="#" onclick="beforeEdit('<s:text name="serviceCode"/>','<s:text name="serviceName"/>','<s:text name="countOfSubmit"/>','<s:text name="price"/>')">修改</a>
	                	&nbsp;&nbsp;
        ...
        <div class="qx" >
       	...
       	<div class="shanchu"><a href="<%=request.getContextPath()%>/sysIncrement/hangCardSetting!beforeAdd.action">增加</a></div>
		<div class="num">
