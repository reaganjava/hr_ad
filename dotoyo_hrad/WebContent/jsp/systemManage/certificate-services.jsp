...
<%@ include file="/jsp/systemManage/left.jsp"%>
    <div class="content-right">
              ...
              <s:if test="dtoList!=null">
	              ...
	              <tr>
	                ...
	                <td width="18%" align="left" class="inside-links">
	                	<a href="#" onclick="beforeEdit('<s:text name="serviceCode"/>','<s:text name="serviceName"/>','<s:text name="timesOfLookup"/>','<s:text name="price"/>')">修改</a>
	                	&nbsp;&nbsp;
        ...
        <div class="qx" >
       	...
       	<div class="shanchu"><a href="<%=request.getContextPath()%>/sysIncrement/huntCardSetting!beforeAdd.action">增加</a></div>
		<div class="num">
