...
<jsp:include page="/jsp/systemManage/left.jsp"></jsp:include>
    <div class="content-right">
    	<div class="administrator-title"><strong>修改猎证服务设置</strong></div>
    	<s:form name="sysIncrementHuntCardFM" method="post" action="huntCardSetting!edit.action">
	 	    ...
	 	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
	              ...
	              <tr>
	                ...
	                <td width="80%" align="left">
	                	<s:textfield name="dto.timesOfLookup" cssStyle="ime-mode:disabled" maxLength="10"
	       	...
	       	<div class="system-botton">
	        	<ul>
	            	<li class="botton1"><a href="#" onclick="document.getElementById('priceValue').value=document.getElementById('dto.price').value;document.getElementsByName('sysIncrementHuntCardFM')[0].submit()" title="保存">保存</a></li>
	                <li class="botton3"><a href="<%=request.getContextPath()%>/sysIncrement/huntCardSetting!cancel.action" title="取消">取消</a></li>
	            </ul>
	        </div>
      	</s:form>
  		</div>
